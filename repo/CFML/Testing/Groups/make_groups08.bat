...
rem > Compilation
   if [%_COMP%]==[ifort] (
      ifort /c groups08.f90   /nologo %OPT1% /I%CRYSFML08%\%DIRECTORY%\include
      ifort /exe:groups08 *.obj /nologo /Qdiag-disable:10448 %CRYSFML08%\%DIRECTORY%\lib\crysfml08.lib /link /stack:300000000 /nologo
   )
rem
   if [%_COMP%]==[gfortran] (
      gfortran -c groups08.f90           %OPT1% -I%CRYSFML08%\%DIRECTORY%\LibC
      gfortran -o groups08.exe *.o -L%CRYSFML08%\%DIRECTORY%\LibC -lcrysfml
   )
rem
